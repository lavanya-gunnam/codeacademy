        ...
        <Grid container spacing={2} justifyContent="center">
          ...
          <Grid item xs={12} sm ={12} md={5}>
            <Item sx={{ marginTop: 10 }}>
              <Typography sx={{ fontSize: '2.75rem', fontWeight: '700', lineHeight: '1.2', color:'#fff', marginBottom:3 }}>Start for free</Typography>
              <Typography sx={{ fontSize: '1rem', fontWeight: '400', lineHeight: '1.2', color:'#fff'}}>If you’ve made it this far, you must be at least a little curious. Sign up and take the first step toward your goals.</Typography>
